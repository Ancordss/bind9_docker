...
test1:
	@echo "\033[1;36mtriying to service2 with a custom dns\033[0m"
	docker exec -it service1 nslookup service2.so2umg.xyz

test2:
	@echo "\033[1;36mtriying to resolve google.com with the custom dns\033[0m"
	docker exec -it service1 nslookup google.com 

test3:
	@echo "\033[1;36mtriying to resolve api1.so2umg.xyz with the custom dns\033[0m"
	docker exec -it service1 nslookup api1.so2umg.xyz

test4:
	@echo "\033[1;36mtriying to get the response from api1.so2umg.xyz with the custom dns\033[0m"
